...
namespace csDelaunay
{
    ...
    public class Voronoi
    {
        ...
        public Voronoi(List<Vector2f> points, Rectf plotBounds, Random weigthDistributor)
        {
            this.weigthDistributor = weigthDistributor;
            Init(points, plotBounds);
        }

        public Voronoi(List<Vector2f> points, Rectf plotBounds, int lloydIterations, Random weigthDistributor = null)
        {
            this.weigthDistributor = weigthDistributor;
            Init(points, plotBounds);
